class PochiAT991400 < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      ...
      sha256 = "8a44132b5d2ad961ef9009ab70052e921ea040a30af20d1864a7b92bdd2d939c"
    else
    ...
    if Hardware::CPU.intel?
      ...
      sha256 = "5b00e6797b5dc3c797981ff77530467a60f2f9cad7d74c6acd23e196cc74cfab"
    else
